...
- toevoeging van functie `macev_groep()` om de macrofaunagroep te bepalen.
- aanpassing van functie `basiskaart()` ivm API-key voor Carto-kaartlagen.

# HHSKwkl 0.5.2

*Nieuw*

- `get_brand_hhsk()` en `get_template_hhsk()` toegevoegd voor vereenvoudigde installatie van brand_hhsk voor Quarto.
